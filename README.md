...
**Current release: 0.3.2.** Includes a visual Markdown composer, local image cards, tag selection, reflection prompts, and hide-and-explain. GitHub release availability and Obsidian community review are separate; check the community listing for review status.

[Download 0.3.2](https://github.com/ekowang-pd/obsidianknow/releases/tag/0.3.2) · [Report an issue](https://github.com/ekowang-pd/obsidianknow/issues)
...
**当前正式发布版本为 0.3.2，市场审核状态请以社区页面为准。** 上面的四张图依次展示目录浏览、阅读、写下自己的理解，以及隐藏原文后复述。
