...
## Overview
Deer Notes helps you keep useful passages and the ideas they spark, together in your vault. Browse readable note cards, open Markdown in a focused reader, select a passage, and save an excerpt with your own thoughts and a link back to the source.
...
Your notes stay ordinary Markdown files. Saving an excerpt does not modify the source. The plugin makes no network requests and has no telemetry. Desktop is the primary testing target; mobile remains unverified. Requires Obsidian 1.7.2 or later.

Screenshot assets: assets/screenshots/browse.png, reading.png, reflection.png, recall.png. All use demonstration content in the shared browser preview; native themes can look different.
